...
public class ProductController {
    ...
    public String showProductPage(@RequestParam(value = "brandId", required = false) Integer brandId, 
        ...
        Page<Product> productPage = productService.getFilteredAndPaginatedProducts(brandId, categoryId, keyword, status, pageable);
        ...
        return "product_template/productPage"; 
    }
    ...
    public String editForm(@PathVariable("id") Integer id, ModelMap model) {
        ...
        return "product_template/editProduct";
    }
